...
function Aside() {
  return (
    <Flex alignItems="center" mt="200" mb="20">
      <Flex w="250px" h="80px">
        <Image p="6" src="https://www.frontendmentor.io/static/images/logo-desktop.svg" />
      </Flex>

      <Spacer />
      <Flex h="80px" alignItems="center" justifyContent="center">
        <Text ml="4" as="em" fontWeight="bold" cursor="pointer" fontSize="36" color="blue.300">
          <Link href="https://twitter.com/login?lang=tr" target="_blank">
            <AiOutlineTwitter />
          </Link>
        </Text>
        <Text ml="8" as="em" fontWeight="bold" cursor="pointer" fontSize="36" color="blue.300">
