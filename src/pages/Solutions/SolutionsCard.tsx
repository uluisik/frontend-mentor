import { Flex, Text, Image, Heading, Spacer, Divider } from '@chakra-ui/react';
    ...
    <Flex>
      ...
      >
        ...
        <Text p="3" mt="1" fontSize="lg">
          Sometimes I'm not sure about my coding solutions; I don't know whether it's the right way
          to do it or not, but somehow I made it even though it's not perfect. Can you please give
          me some advice about my code? thank you
        </Text>
